...
export const HOW_TO_PLAY_HTML = [
  ...
  '<h3 class="text-lg font-bold text-gray-900 mb-2 print:text-base">The Basics</h3>',
  ...
  '</ol>',
  '<h3 class="text-lg font-bold text-gray-900 mt-5 mb-2 print:text-base">Scoring (Optional)</h3>',
  ...
  '<h3 class="text-lg font-bold text-gray-900 mt-5 mb-2 print:text-base">Tips</h3>',
